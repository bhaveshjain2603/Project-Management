      ...
      <div className="px-4 mb-3 flex items-center justify-between">
        ...
        <ul className="border-r border-gray-300 pr-2">
          {projects.map((project, index) => (
            <li key={index} className={`px-5 py-1.5 mb-1 text-gray-600 text-sm capitalize select-none hover:text-indigo-600 rounded transition-colors hover:bg-indigo-200/80 ${paramsWindow === project._id && 'text-indigo-600 bg-indigo-200/80'}`}>
